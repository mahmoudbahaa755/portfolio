          ...
          <div className="space-y-4">
            <section>
              ...
              <p>
                ...
                discovered my passion for creating beautiful and functional user
                interfaces. Since then, I've worked on various projects, from
            ...
            <section>
              ...
              <p>
                ...
                up-to-date with the latest frontend technologies. My goal is to
                create web experiences that are not only visually appealing but
                also performant and accessible to all users.
              </p>
            </section>
            <section>
