  ...
  return (
    ...
    >
      <div ref={textRef} className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
        <motion.h1 className="text-4xl md:text-5xl font-bold mb-6 gradient-text" variants={itemVariants}>
          John Doe
        </motion.h1>
        <motion.h2 className="text-2xl md:text-3xl mb-4" variants={itemVariants}>
      ...
      <motion.div ref={imageRef} className="md:w-1/2 flex justify-center" variants={itemVariants}>
        <Image
